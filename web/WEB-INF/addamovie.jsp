...
<html>
    ...
    <div class="col-sm-10 col-lg-5 content form">
        ...
        <form method="post" action="${pageContext.request.contextPath}/addamovie" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <textarea type="text" class="form-control" required placeholder="Résumé" name="resume" id="resume"
                          rows="4"></textarea>
                <p class="nb-char">Il vous reste <span id="reste_char"></span> caractères.</p>
            </div>
            <div class="form-group">
                <input type="text" name="trailer" placeholder="Bande annonce (lien youtube optionnel)"
                       class="form-control"/>
            </div>
